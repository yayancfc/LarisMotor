...
public class FilteredPendingJualActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_filtered_pending_jual);
    ...
    private void dialogueFilterPending() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(FilteredPendingJualActivity.this);
        View rootDialog = LayoutInflater.from(FilteredPendingJualActivity.this).inflate(R.layout.dialogue_filter_pending, null);
    ...
    private void setFilter() {
        ...
        Call<List<PendingJual>> call = apiInterface.getFilteredPendingJual(id, merk, tipe);
    ...
    private void getMerk() {
        ...
        call.enqueue(new Callback<List<Merk>>() {
            ...
            public void onResponse(Call<List<Merk>> call, Response<List<Merk>> response) {
                ...
                merkAdapter = new ArrayAdapter<>(FilteredPendingJualActivity.this, android.R.layout.simple_spinner_item, merkArray);
        ...
        spinnerMerk.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (position == 0) {
                    ...
                    tipeAdapter = new ArrayAdapter<>(FilteredPendingJualActivity.this, android.R.layout.simple_spinner_item, tipeArray);
